...
5. Buat database baru dengan nama persis: cryptomath_db
   
7. Pilih database tersebut, masuk ke tab Import, lalu pilih dan unggah file cryptomath_db.sql yang ada di dalam folder proyek ini.
